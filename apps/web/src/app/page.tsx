...
export default function Home() {
	...
	return (
		<div className="bg-light-cyan-200">
          ...
          `}
				>
					<Image src="/KMUTT.png" width={0} height={0} sizes="20vw" style={{ width: "auto", height: "50px" }} alt="KMUTT" />
					<div className="text-base font-mali font-bold">ดำเนินการต่อด้วยบัญชี KMUTT</div>
				</button>
			</div>

			<footer className="absolute bottom-0 pl-3 pb-1 text-xs text-deep-twilight-800/25 z-100">©2026 CPE39. All rights reserved.</footer>
			<AnnoyingStickers />
			<ParticlesBackground />
		</div>
	);
